...
const Footer = () => {
  return (
    <footer className="bg-black/20 backdrop-blur-xl border-t border-primary-500/20 text-white py-16">
      <div className="container mx-auto px-6 lg:px-12">
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4 mt-8">
                <a href="https://github.com/sheetal-saini25" target="_blank" rel="noopener noreferrer" className="p-3 bg-white/10 backdrop-blur-lg rounded-2xl hover:bg-white/20 transition-all duration-300 hover:scale-110 border border-primary-500/20">
                  <Github className="w-6 h-6" />
                </a>
                <a href="https://linkedin.com/in/sheetal-saini-b33273371" target="_blank" rel="noopener noreferrer" className="p-3 bg-primary-600/30 backdrop-blur-lg rounded-2xl hover:bg-primary-600/50 transition-all duration-300 hover:scale-110 border border-primary-500/20">
        ...
        <div className="border-t border-primary-500/20 mt-16 pt-8 text-center">
          <p className="text-white/70 flex items-center justify-center gap-2 text-lg">
            Made with <Heart className="w-5 h-5 text-red-400 fill-current animate-pulse" /> and <Code className="w-5 h-5 text-primary-400" /> by Sheetal Saini
          </p>
